class PortfolioGallery {
  constructor() {
    ...
    this.artworks = [
      ...
      },
      {
        ...
        thumb:
          "assets/images/artgallery/awakened from a deep slumber (2024).webp",
      ...
      },
      {
        ...
        thumb:
          "assets/images/artgallery/hexxana portrait grayscale (2022).webp",
      ...
      },
      {
        ...
        thumb:
          "assets/images/artgallery/hexaana close up grayscale (2022).webp",
  ...
  renderGallery() {
    ...
    this.filteredImages =
      this.currentFilter === "all"
        ...
        : this.artworks.filter(
            (artwork) => artwork.category === this.currentFilter
          );
    ...
    this.filteredImages.forEach((artwork, index) => {
      ...
      overlay.innerHTML = `
            ...
            <div class="overlay-category">${artwork.category.replace(
              "-",
              " "
            )}</div>
          `;
  ...
  openLightbox() {
    ...
    setTimeout(() => {
      ...
      document.getElementById("lightbox-category").textContent =
