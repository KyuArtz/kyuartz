      ...
      },
      {
        ...
        minor: [
          ...
          },
          {
            ...
            description:
              "We've created a new dedicated page for world development, where you can view characters, world maps, and lore. Some portions are still a work in progress.",
            category: "Content",
          },
        ],
        bugfixes: [],
        ...
        minor: [
          {
            ...
            description:
              "To improve loading time, the old loader was removed, and minor adjustments were made.",
        ...
        minor: [
          {
            ...
            description:
              "The interface design has been enhanced and modified, and a translucent gradient effect has been added.",
            category: "UI/UX",
          },
          {
      ...
      },
      {
        ...
        minor: [
          ...
          },
          {
            ...
            description:
              "Releasing a small update to our AI asistant interface and added new various functionalities like (AI mood, new chat functionality, functional settings & history modal).",
            category: "UI/UX, AI",
          },
        ],
        bugfixes: [],
        ...
        upcoming: [
          {
            ...
            description:
              "Upgrading Meo with new features, enhanced AI capabilities, and a more interactive experience.",
            category: "AI",
        ...
        minor: [
          {
            ...
            description:
              "Made various improvements to the portfolio section for better usability and performance.",
            category: "Performance",
          },
          {
            title: "Comics section improvements",
            description:
              "Made various improvements to the comics section for better usability and performance.",
            category: "Performance",
          },
        ],
        bugfixes: [],
        ...
        minor: [
          {
            title: "Technical improvements",
            description:
              "Made various technical improvements to enhance performance and maintainability to the site.",
            category: "Performance",
          },
          {
            title: "Character panel improvements",
            description:
              "Made various improvements to the character panel for better usability and performance.",
            category: "Performance",
          },
          {
            title: "Improved Preferences Page",
            description:
              "Enhanced the layout and usability of the Preferences Page.",
            category: "UI/UX",
          },
        ],
        bugfixes: [
          {
            ...
            description:
              "Resolved various layout issues in the character panel for improved usability and known bugs.",
            category: "UI/UX",
          },
        ],
        upcoming: [],
        ...
        major: [
          {
            ...
            description:
              "Redesigned the entire site with a fresh look, improved performance, and enhanced features.",
            category: "UI/UX",
          },
        ],
        minor: [
          {
            ...
            description:
              "The contact page now supports commission requests, general inquiries, and support messages on a single page, featuring a more streamlined and user-friendly UI/UX.",
            category: "Functionality",
          },
          {
            title: "Enhanced Client Queue",
            description:
              "Added search and filter functionality for client names, along with an upgraded interface for a smoother user experience.",
            category: "UI/UX",
          },
          {
            title: "What's New Page",
            description:
              "Replaced the old home-page popup with a dedicated 'What's New' page, offering a cleaner layout and improved UI/UX.",
            category: "Content",
          },
          {
            title: "New Service Center",
            description:
              "Replaced the old help center with a new Service Center that includes Terms of Service, FAQs, and Policies, all accessible through an integrated search function.",
            category: "Navigation",
          },
        ],
        bugfixes: [],
...
function updateHeroStats() {
  ...
  document.getElementById("major-updates").textContent =
    summary.total_major_updates;
...
function renderCardView(updates) {
  if (updates.length === 0) {
    updatesContainer.innerHTML =
      '<div class="no-results">No updates found matching your criteria.</div>';
    return;
  }
...
function createUpdateCard(update) {
  ...
  if (shouldShowSection("major", update.major)) {
    sections.push(
      createUpdateSection("Major Updates", update.major, "major", "🚀")
    );
  }

  if (shouldShowSection("minor", update.minor)) {
    sections.push(
      createUpdateSection("Minor Updates", update.minor, "minor", "✨")
    );
  }

  if (shouldShowSection("bugfixes", update.bugfixes)) {
    sections.push(
      createUpdateSection("Bug Fixes", update.bugfixes, "bugfixes", "🔧")
    );
  }

  if (shouldShowSection("upcoming", update.upcoming)) {
    sections.push(
      createUpdateSection("Upcoming", update.upcoming, "upcoming", "🔮")
    );
  }
...
function shouldShowSection(sectionType, items) {
  return currentFilter === "all" || currentFilter === sectionType
    ? items.length > 0
    : false;
}
