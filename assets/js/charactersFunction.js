...
function showCharacterInfo(character) {
    ...
    if (character === 'elishia') {
        ...
        details = {
            ...
            weapon: "<info><yellow>Solaraenia Staff</yellow></info>",
