...
function getCharacterDetails(character) {
    ...
    if (character === 'elishia') {
        ...
        details = {
            ...
            ability6: "<info><i class='fas fa-skull'></i> We are as one: Reaper’s Wrath</info><p>Transforms into her demon form, amplifying her power. While active, her scythe grows more lethal, her attacks quicken, and her aura instills fear in even the bravest foes.</p>",
            background: [
        ...
        details = {
            ...
            "Her brother, who recognized her passion, potential and a past promise her mother made for her, became her silent ally, offering tips and guidance away from their father's watchful eyes. When news of a prestigious tournament spread through the land of the hidden mist valley, Rayza saw her chance. She entered the competition in disguise, hiding her face to avoid recognition. Her heart pounded as she faced each opponent, her confidence growing with every victory. One by one, she defeated nine challengers, advancing to the final round. To her shock, her last opponent was none other than Ren.<br><br>",
        ...
        details = {
            ...
            "In the heart of that devastation, Liliana stood witness to the unthinkable: her aunt, Blessica, sacrificing herself to seal Lunara due to corruption and prevent further destruction. As the sealing spell took its toll, Blessica grew weak and began to fade. In her final moments, she entrusted young Liliana with a sacred vow to lead their people, restore the broken world, and protect the future. Liliana, still young, gave a solemn nod as Blessica ascended in a burst of divine light, her spirit returning to the heavens in eternal slumber. All present mortals, celestials, and warriors alike knelt before Liliana as she rose into the air, her aura radiant with divine purpose despite having an umbrakith bloodline mixed with solaraenian. With a steady breath and unwavering heart, she cast a spell that summoned a great beam of light from the heavens. It poured down upon her like a blessing, encasing her in brilliance while eldoria is crumbling.<br><br>",
            "As the light engulfed her, Liliana extended her hands and in them, a crystal began to form a beacon surge, pulsing with pure energy. The crystal glowed brighter with every heartbeat, resonating with the very soul of Eldoria. In a single, luminous surge, the light rippled outward. Darkness recoiled. The broken land around her shimmered, and corruption melted into air. With that act, she did not just cleanse the land she gave the people hope.<br><br>",
            "From that moment, Liliana was no longer seen as a child of tragedy, but as the new dawn reborn.<br><br>",
        ...
        details = {
            ...
            background: [
            "Floribeth, guardian of nature and master of floramancy, once ruled the vast and vibrant Luminwood Expanse a realm where flora and fauna danced in perfect harmony. A former elite of the ancient faction led by Princess Lunara, Floribeth eventually stepped away from her old ties, seeking a deeper purpose. With a heart rooted in healing and preservation, she founded her own faction: the Bloomforge Order, sworn to protect the Tree of Life, the sacred heart of Eldoria itself roots stretching through generations of time.<br><br>",
            "Her homeland was once a breathtaking expanse of lush valleys, mystical groves, and ancient trees that whispered tales of old. Diverse in culture and wild in spirit also home to the elves, it was paradise. But after the devastating Great War, the land was left wounded and corrupted its spirit dimmed, its beauty scarred. Still, Floribeth remained unwavering. Her mission: to restore Luminwood to its former glory and protect it from any threat that dared approach. Peace, however, was fleeting<br><br>",
