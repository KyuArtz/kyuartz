...
function getCharacterDetails(character) {
    ...
    if (character === 'elishia') {
        details = {
            ...
            ability5: "<label><i class='fas fa-robot'></i> Falcon Drone: Meo-9</label> <p>Deploys her custom support drone “Meo-9.” It provides cover fire, revives nearby allies once per deployment, and emits a brief EMP pulse on destruction.</p>",
