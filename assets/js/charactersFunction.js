...
function getCharacterDetails(character) {
    ...
    if (character === 'elishia') {
        details = {
            ...
            ability1: "<strong><i class='fas fa-microchip'></i> Biotech Overdrive</strong> <p>Temporarily enhances reflexes and reaction time through internal nanotech boosts. Increases accuracy, reload speed, and evasion.</p>",
            ability2: "<strong><i class='fas fa-radiation'></i> Viral Sweep</strong> <p>Deploys a tech-plasma burst that neutralizes organic plague entities. Deals damage over time and halts regeneration in infected targets.</p>",
            ability3: "<strong><i class='fas fa-eye'></i> Tactical Scan</strong> <p>Reveals enemies through walls and weak points in armor. Grants temporary critical chance bonus to allies who attack scanned targets.</p>",
            ability4: "<strong><i class='fas fa-shield-alt'></i> Adaptive Barrier</strong> <p>Deploys a reactive energy shield that shifts to counter incoming damage types. Can protect a wide area or follow a single target.</p>",
            ability5: "<strong><i class='fas fa-robot'></i> Falcon Drone: Meo-9</strong> <p>Deploys her custom support drone “Meo-9.” It provides cover fire, revives nearby allies once per deployment, and emits a brief EMP pulse on destruction.</p>",
            ability6: "<strong><i class='fas fa-biohazard'></i> Redline Protocol</strong> <p>Activates Elishia’s failsafe mode—sacrificing defensive functions to maximize speed, firepower, and aggression. All cooldowns are reduced, but damage taken is increased. Ends with a powerful anti-plague discharge blast.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-mask'></i> darkcraft</strong> <p>Hexxana bends darks into blades, cloaks, or illusions—shifting reality at will. These constructs disorient enemies and cloak her movements.</p>",
            ability2: "<strong><i class='fas fa-circle'></i> Umbral Rift</strong> <p>Opens a swirling rift that distorts space and pulls enemies inward. Hexxana can phase through the rift to reposition instantly. Deals continuous void damage over time.</p>",
            ability3: "<strong><i class='fas fa-skull-crossbones'></i> Curse Weaving</strong> <p>Hexxana enchants enemies or her weapon with potent hexes. Inflicts mental disarray, weakens armor, or causes delayed detonation. Some effects linger even after death.</p>",
            ability4: "<strong><i class='fas fa-hand-sparkles'></i> Void Tendrils</strong> <p>Summons darky tendrils from the ground to lash and bind enemies, draining energy and immobilizing them. Effective for crowd control or disabling targets.</p>",
            ability5: "<strong><i class='fas fa-wind'></i> dark Reaping</strong> <p>Channels void energy through Oblivion’s Edge, releasing spectral slashes in wide arcs. Each strike pierces defenses and leeches vitality from enemies.</p>",
            ability6: "<strong><i class='fas fa-fire'></i> Oblivion Form: We are as One</strong> <p>Hexxana ascends into her true cursed state, becoming a spectral demon. Her speed increases, attacks ignore resistances, and enemies nearby are afflicted with fear. Oblivion’s Edge becomes engulfed in anti-light, burning through both body and spirit.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-fire'></i> Blazing Fang</strong> <p>Strikes with his twin blades, igniting the target with fire-enhanced slashes. Each successful hit increases burn duration and stacks toward combo finishers.</p>",
            ability2: "<strong><i class='fas fa-tornado'></i> Whirlwind Edge</strong> <p>Spins forward in a sweeping circular strike. Deals AoE damage around him and knocks enemies back. If used during Bloodheat, adds a fire shockwave.</p>",
            ability3: "<strong><i class='fas fa-dragon'></i> Dragonbound Leap</strong> <p>Leaps high into the air and crashes down with explosive force. Leaves behind searing flame at the impact zone. Grants armor while airborne.</p>",
            ability4: "<strong><i class='fas fa-user-secret'></i> Phantom Dash</strong> <p>Dashes forward invisibly, striking from behind with precision. Grants critical damage boost if used out of sight.</p>",
            ability5: "<strong><i class='fas fa-swords'></i> Broadsoul Fusion</strong> <p>Temporarily fuses his Dual Fang Blades into a massive broadsword made of draconic flame. Increases range, adds sweeping attacks, and cleaves through enemy defenses.</p>",
            ability6: "<strong><i class='fas fa-bolt'></i> Bloodheat Ascension</strong> <p>Ren taps into his awakened Dragonkin bloodline, enveloping himself in a burning aura. While active, all attacks deal fire AoE, stagger resistance is increased, and he regenerates health per kill. Ends with an explosive finisher if activated again.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-cloud'></i> Mist Veil</strong> <p>Rayza disappears in a sudden burst of fog, becoming invisible and untargetable for a few seconds. Her next attack from stealth deals bonus wind damage.</p>",
            ability2: "<strong><i class='fas fa-wind'></i> Wind Blades</strong> <p>Unleashes sharp wind crescents from her dual blades in a wide arc. Can be charged for focused piercing strikes that knock enemies back.</p>",
            ability3: "<strong><i class='fas fa-fan'></i> Dance of the Tempest</strong> <p>Performs a rapid series of agile strikes and dashes between enemies. Each strike gains critical chance if Rayza is midair or above her target.</p>",
            ability4: "<strong><i class='fas fa-shoe-prints'></i> Silent Step</strong> <p>Grants enhanced movement speed and silence. While active, Rayza leaves behind no trace or sound, and gains bonus evasion from ranged attacks.</p>",
            ability5: "<strong><i class='fas fa-leaf'></i> Petal Storm</strong> <p>Summons a spiraling windstorm filled with sharp petals that cut all enemies caught inside. Foes are slowed and receive continuous bleed damage.</p>",
            ability6: "<strong><i class='fas fa-fire'></i> Blood Rage</strong> <p>When pushed to her limit, Rayza unleashes her latent bloodline power. Her aura turns crimson, increasing attack speed, agility, and damage output dramatically. While active, her abilities become enhanced versions and leave afterimages in her wake.</p>",
            background: [
        ...
        details = {
            ...
            role: "<info>Healer</info> <info>Mage</info>",
            ...
            ability1: "<strong><i class='fas fa-praying-hands'></i> Lightweave</strong> <p>Channels pure light to cleanse allies of curses and restore health over time. Deals radiant damage to undead or corrupted enemies touched by the stream.</p>",
            ability2: "<strong><i class='fas fa-snowflake'></i> Frostguard Halo</strong> <p>Encases a target in a barrier of divine frost. Reduces damage taken and slows attackers. Shatters after absorbing damage, freezing nearby enemies.</p>",
            ability3: "<strong><i class='fas fa-dove'></i> Aurora Prayer</strong> <p>Liliana raises her staff, calling down a serene aurora. Allies within its glow are healed, gain regeneration, and feel temporarily immune to fear or charm effects.</p>",
            ability4: "<strong><i class='fas fa-star'></i> Dawnburst</strong> <p>Fires a concentrated burst of solar light that pierces through enemies in a straight line. Blinds and damages targets hit, especially those aligned with darkness.</p>",
            ability5: "<strong><i class='fas fa-hand-holding-heart'></i> Radiant Safeguard</strong> <p>Projects a divine ward on all nearby allies, granting immunity to lethal damage for a brief time. When triggered, leaves behind a soothing trail of light.</p>",
            ability6: "<strong><i class='fas fa-sun'></i> Ascendant Blessing</strong> <p>Liliana enters a divine trance, glowing with Solaraenian power. All healing is amplified, light abilities deal extra radiant damage, and fallen allies within her aura are revived with partial health. Lasts for a short duration.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-moon'></i> Moonveil Curse</strong> <p>Calls upon tainted celestial energy to cast a weakening veil on enemies, lowering their magic resistance and stamina. Under the moon’s gaze, the effect intensifies.</p>",
            ability2: "<strong><i class='fas fa-burn'></i> Bloodbinding</strong> <p>Manipulates the blood of enemies within range, restricting their movement or forcing them to act against their will. Overuse risks backlash to Lunara's own vitality.</p>",
            ability3: "<strong><i class='fas fa-skull'></i> Lament of the Exiled</strong> <p>Unleashes a wave of cursed memories that damage enemies and sap their morale. Those affected may hallucinate visions from Lunara’s broken past.</p>",
            ability4: "<strong><i class='fas fa-fire'></i> Crimson Howl</strong> <p>Releases a piercing scream that erupts into a shockwave of corrupted light and blood magic. Deals high AoE damage and instills fear in those who survive.</p>",
            ability5: "<strong><i class='fas fa-heart-broken'></i> Heartsplit</strong> <p>Fires a concentrated bolt of celestial and void magic that detonates on impact. Targets struck are cursed to suffer bonus damage from future spells.</p>",
            ability6: "<strong><i class='fas fa-crown'></i> Blood Eclipse</strong> <p>Unleashes her sealed form as the Scarlet Phantom. Her aura corrupts the battlefield, amplifying all abilities, draining enemies nearby, and marking them with the Reaper’s Sigil. During this form, Lunara regenerates from all damage dealt.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-fire'></i> Foxfire Embers</strong> <p>Summons dancing flames shaped like fox spirits to attack enemies in a wide area. Embers trail behind Feya for several seconds, damaging foes that follow.</p>",
            ability2: "<strong><i class='fas fa-ghost'></i> Spirit Rush</strong> <p>Feya transforms into a blazing fox spirit and dashes through enemies, phasing through them and leaving a trail of fire. Grants brief invulnerability and speed.</p>",
            ability3: "<strong><i class='fas fa-sun'></i> Eclipse Flare</strong> <p>Charges a burst of radiant fire that explodes outward in a sun-shaped blast, burning enemies and weakening their elemental resistance. Empowered if cast near allies.</p>",
            ability4: "<strong><i class='fas fa-paw'></i> Infernal Vulpes</strong> <p>Summons a giant spectral fox engulfed in flame that charges forward, knocking enemies airborne and burning the battlefield in its wake.</p>",
            ability5: "<strong><i class='fas fa-seedling'></i> Radiant Safeguard</strong> <p>Surrounds allies in a barrier of nature-infused fire that absorbs damage and burns attackers. Strength increases if Feya is under half HP.</p>",
            ability6: "<strong><i class='fas fa-star'></i> Vulpine Ascension</strong> <p>Feya awakens her true form—a celestial fox spirit wreathed in infernal fire. During this state, all abilities are empowered, and attacks gain burn and lifesteal effects. Her eyes glow, her tails flare, and the battlefield bends to her will.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-shield-alt'></i> Bloomguard</strong> <p>Envelops an ally in a protective floral shield that absorbs incoming damage. When the shield breaks, it releases a burst of healing energy to nearby allies.</p>",
            ability2: "<strong><i class='fas fa-leaf'></i> Thornwall</strong> <p>Summons a wall of living vines that blocks enemy movement and ranged attacks. Allies standing behind it gain bonus defense for a short time.</p>",
            ability3: "<strong><i class='fas fa-spa'></i> Soothing Petals</strong> <p>Releases a gentle wave of floating petals around Floribeth, slowly healing allies over time. The effect is stronger on targets with active shields.</p>",
            ability4: "<strong><i class='fas fa-hand-holding-heart'></i> Verdant Embrace</strong> <p>Targets an ally or herself to receive a burst of healing and a brief shield. If the ally is below 50% HP, the shield’s strength is doubled.</p>",
            ability5: "<strong><i class='fas fa-globe'></i> Sanctuary Bloom</strong> <p>Creates a sanctuary zone of glowing flora that lasts several seconds. Allies inside are shielded over time and gradually regenerate health while inside the bloom radius.</p>",
            ability6: "<strong><i class='fas fa-star-of-life'></i> Blooming Ascension</strong> <p>Floribeth invokes the essence of the Tree of Life, ascending into a radiant spirit form. While active, healing effects are doubled, enemies nearby are pacified, and all allies regenerate mana and stamina steadily. Her presence revives fallen allies with partial health if cast at the center of Springvale.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-leaf'></i> Verdant Volley</strong> <p>Fires a rapid volley of arrows imbued with nature magic. Each hit has a chance to root the enemy in place with entwining vines.</p>",
            ability2: "<strong><i class='fas fa-wind'></i> Whisperstep</strong> <p>Arzhel moves silently through terrain, gaining invisibility near natural cover. His next shot from stealth deals critical damage and applies a slow.</p>",
            ability3: "<strong><i class='fas fa-bullseye'></i> Bloomshot</strong> <p>Channels power into a single arrow that explodes into petals upon impact. Deals area damage and briefly blinds enemies hit by the bloom flash.</p>",
            ability4: "<strong><i class='fas fa-shield-alt'></i> Guardian’s Watch</strong> <p>Places a warding seed on the ground that blooms into a protective dome, shielding allies and revealing invisible enemies within its range.</p>",
            ability5: "<strong><i class='fas fa-seedling'></i> Wildroot Trap</strong> <p>Plants a trap that activates when stepped on, entangling enemies with thorned vines and applying nature damage over time.</p>",
            ability6: "<strong><i class='fas fa-tree'></i> Bloomshaper’s Mark</strong> <p>Marks a target with an ancient sigil. All of Arzhel’s attacks against the marked enemy are empowered, and allies gain increased accuracy against the target.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-water'></i> Tidecall</strong> <p>Summons a surge of high-pressure water to knock back enemies in front of her. The wave slows targets and cleanses ally debuffs in its path.</p>",
            ability2: "<strong><i class='fas fa-music'></i> Siren’s Hymn</strong> <p>Releases a haunting song that calms aggressive foes and bolsters allies’ regeneration and magic resistance.</p>",
            ability3: "<strong><i class='fas fa-bullseye'></i> Deep Pierce</strong> <p>Throws a water-forged harpoon imbued with magic. Pierces through multiple enemies and reduces defense on hit.</p>",
            ability4: "<strong><i class='fas fa-shield-alt'></i> Abyssal Veil</strong> <p>Surrounds herself in a watery shield that absorbs damage and reflects a portion of it as magical backlash.</p>",
            ability5: "<strong><i class='fas fa-seedling'></i> Coral Sanctuary</strong> <p>Creates a sanctuary zone of blooming coral. Allies within are healed over time and gain resistance to crowd control effects.</p>",
            ability6: "<strong><i class='fas fa-tree'></i> Ocean’s Wrath</strong> <p>Shelain calls upon the ancient power of the seas, conjuring a massive whirlpool beneath her foes. Deals AoE damage over time and pulls enemies to the center.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-shield-alt'></i> Celestial Aegis</strong> <p>Manifests a radiant shield of divine light that orbits Blessica or an ally, absorbing incoming damage. When broken, it emits a pulse that knocks back nearby enemies.</p>",
            ability2: "<strong><i class='fas fa-bolt'></i> Lance of Dawn</strong> <p>Conjures a spear of blazing light and hurls it forward. Pierces through multiple enemies, dealing radiant damage and leaving behind a trail of burning ground.</p>",
            ability3: "<strong><i class='fas fa-hands'></i> Solarae’s Embrace</strong> <p>Blessica channels divine energy to rapidly heal an ally. If the target is under 50% health, the healing is doubled and grants temporary invulnerability to status effects.</p>",
            ability4: "<strong><i class='fas fa-people-arrows'></i> Radiant Bind</strong> <p>Calls down beams of light that tether enemies in a small area, reducing their movement speed and attack damage for a short duration.</p>",
            ability5: "<strong><i class='fas fa-cross'></i> Dawnbreaker Oath</strong> <p>Blessica plants her spear into the ground, creating a protective field. Allies inside take reduced damage and regenerate stamina. Enemies that enter are briefly blinded.</p>",
            ability6: "<strong><i class='fas fa-sun'></i> Final Benediction</strong> <p>Blessica ascends briefly in a halo of divine light. During this state, she gains flight, her attacks pierce defenses, and all allies nearby receive constant healing. Ends in a radiant burst that revives one fallen ally with enhanced resistance.</p>",
            background: [
        ...
        details = {
            ...
            ability1: "<strong><i class='fas fa-bolt'></i> Elemental Attunement</strong> <p>Zenyx channels her inner magic to attune herself to one of the four primal elements—Fire, Water, Air, or Earth. Each attunement changes the effects of her other abilities, offering versatile tactical choices.</p>",
            ability2: "<strong><i class='fas fa-compress-arrows-alt'></i> Flux Surge</strong> <p>Releases a burst of elemental energy matching her current attunement. Fire scorches enemies, Water slows and heals allies, Air pushes back enemies, and Earth fortifies defenses. Gains enhanced effects if combined with another element.</p>",
            ability3: "<strong><i class='fas fa-wave-square'></i> Elemental Fusion</strong> <p>Combines two active elements into a powerful hybrid spell. Examples include Steam Burst (Fire+Water), Sandstorm (Air+Earth), Lightning Storm (Fire+Air), or Crystalize (Water+Earth). Deals heavy damage or grants strategic buffs based on the fusion.</p>",
            ability4: "<strong><i class='fas fa-shield-alt'></i> Elemental Ward</strong> <p>Creates a protective barrier imbued with her current element. Fire Ward burns attackers, Water Ward regenerates health, Air Ward increases evasion, and Earth Ward absorbs damage. Fusion barriers gain multiple effects.</p>",
            ability5: "<strong><i class='fas fa-radiation'></i> Elemental Overload</strong> <p>Temporarily unlocks full elemental power, allowing Zenyx to rapidly switch attunements without cooldowns. Her spells hit harder and may trigger random combo effects during the duration.</p>",
            ability6: "<strong><i class='fas fa-sun'></i> Prismatic Tempest</strong> <p>Zenyx unleashes all attuned elements in a massive area-of-effect storm. Fire, Water, Air, and Earth swirl together, dealing heavy damage, applying multiple debuffs, and empowering allies caught within the radiant surge.</p>",
            background: [
        ...
        details = {
            ...
            likes: "<info><i class='fas fa-check'></i> Unknown</info>",
            dislikes: "<info><i class='fas fa-times'></i> Unknown</info>",
            weapon: "<strong><i class='fas fa-heart'></i> Unknown</info>",
            ability1: "<strong><i class='fas fa-star'></i> Ability 1</strong> <p>Description coming soon.</p>",
            ability2: "<strong><i class='fas fa-star'></i> Ability 2</strong> <p>Description coming soon.</p>",
            ability3: "<strong><i class='fas fa-star'></i> Ability 3</strong> <p>Description coming soon.</p>",
            ability4: "<strong><i class='fas fa-star'></i> Ability 4</strong> <p>Description coming soon.</p>",
    ...
    function renderBasicInfo(details) {
        return `
            ...
            <h3><i class="fa-regular fa-circle-question"></i> Basic Information</h3>
                <content><strong><i class='fas fa-user'></i> Race</strong> ${details.race}</content>
                <content><strong><i class='fas fa-venus-mars'></i> Gender</strong> ${details.gender}</content>
                <content><strong><i class='fas fa-ruler-vertical'></i> Height</strong> ${details.height}</content>
                <content><strong><i class='fas fa-globe'></i> Homeland</strong> ${details.homeland}</content>
                <content><strong><i class='fas fa-shield-alt'></i> Faction</strong> ${details.faction}</content>
                <content><strong><i class='fas fa-crown'></i> Role</strong> ${details.role}</content>
                <content><strong><i class='fas fa-briefcase'></i> Occupation</strong> ${details.occupation}</content>
            </div>
        `;
    }
